...
def main():
    ...
    retorno = The_X_Men.Mystyca(titulo='Menu1',  b_exe=True, tipo_index='a', b_exec_all=False, b_loop=True , pad_x=50)
...
def explicacion_parametros():
    ...
    ■ [b_exe](bool)      True  ◄► Cuando sale de aquí ya se ha ejecutado la funcion del menu.....lleve donde lleve, pero tiene que estar  
