...
from fromdvd.classMenuDvd.classXindeX import Over_Main
# from fromdvd.classMenuDvd.classMotorMain import Over_Main

# ====================================================
# DEF: MAIN QUE DEFINE UN FORMULARIO Y UN Menu   
# ====================================================


hilo_form_BBDD = None
""" >>> el threading del formulario. """
# ###########
def main():
    """ CASUISTICA 1
    Lanzo el Thread en el main y lo paso como parametro a la clase xindicex en la creacion de la clase y en el main.
    """
    """ CASUISTICA 2 
    Lanzo el Thread en la clase XindiceX. XindiceX la declaro en el main.
    """
    """ CASUISTICA 3 
    Lanzo el Thread en la clase XindiceX, pero creado en el main. para hacerlo de primer nivel.
    """
...
def f_cajas():
    os.system('cls')
    print('\n C A J A S ')
    from  over_main_Enfileitor import prueba_enfileitor as Tk_Filas
    Tk_Filas()
# _____________________
...
def guardar_menu():
    ...
    print("""- Crear las Tablas 
    - Conectar con la Base de datos
    - Insertar  """ )

def lanza_flask():
    print('L a n z a   F l a s k ')
    # from funciones6completo.main import main as star_flask
    # # from over_funciones6_completo import main as star_flask
    # star_flask()
    # from fromdvd.classMenuDvd.classXindeX import XindeX 
    # from proyecto_final_v1.funciones_tablas import funciones_tablas 
